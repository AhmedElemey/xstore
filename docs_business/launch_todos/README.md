...
| # | File | Topic |
|---|------|--------|
| 1 | [01_scope_launch.md](./01_scope_launch.md) | Launch scope: COD marketplace vs delivery pilots |
| 2 | [02_vendor_supply.md](./02_vendor_supply.md) | Vendor web catalog + admin moderation |
| 3 | [03_funnel_metrics.md](./03_funnel_metrics.md) | North-star funnel and instrumentation |
...
To share by email: attach these files or zip `docs_business/launch_todos/`.
