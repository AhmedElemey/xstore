...
mixin _$RegisterParams {
  ...
  String get password => throw _privateConstructorUsedError; // Vendor only
...
// Vendor only
  ...
  @override
  String toString() {
    return 'RegisterParams(role: $role, fullName: $fullName, email: $email, phoneNumber: $phoneNumber, countryCode: $countryCode, dateOfBirth: $dateOfBirth, location: $location, password: $password, storeName: $storeName, storeCategory: $storeCategory, storeDescription: $storeDescription, storeLogoPath: $storeLogoPath, storeCity: $storeCity, storeWilaya: $storeWilaya, whatsappNumber: $whatsappNumber)';
  }
...
abstract class _RegisterParams implements RegisterParams {
  const factory _RegisterParams(
      ...
      final String? storeCity,
      final String? storeWilaya,
      final String? whatsappNumber}) = _$RegisterParamsImpl;
