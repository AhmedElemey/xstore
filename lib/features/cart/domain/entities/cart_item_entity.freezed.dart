...
class _$CartItemEntityImpl implements _CartItemEntity {
  ...
  @override
  String toString() {
    return 'CartItemEntity(id: $id, listingId: $listingId, listingName: $listingName, listingImage: $listingImage, listingSlug: $listingSlug, vendorId: $vendorId, vendorName: $vendorName, vendorStoreName: $vendorStoreName, vendorAvatar: $vendorAvatar, vendorRating: $vendorRating, vendorVerified: $vendorVerified, price: $price, compareAtPrice: $compareAtPrice, quantity: $quantity, maxQuantity: $maxQuantity, category: $category, condition: $condition, shippingAvailable: $shippingAvailable, shippingCost: $shippingCost, isAvailable: $isAvailable, addedAt: $addedAt)';
  }
...
abstract class _CartItemEntity implements CartItemEntity {
  const factory _CartItemEntity(
      ...
      required final String listingImage,
      final String listingSlug,
      ...
      final double shippingCost,
      final bool isAvailable,
      required final DateTime addedAt}) = _$CartItemEntityImpl;
