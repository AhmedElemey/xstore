    ...
    return _then(_value.copyWith(
      ...
      storeViewCount: null == storeViewCount
          ...
          : storeViewCount // ignore: cast_nullable_to_non_nullable
              as int,
      storeSaveCount: null == storeSaveCount
          ? _value.storeSaveCount
          : storeSaveCount // ignore: cast_nullable_to_non_nullable
              as int,
      storeActiveListings: null == storeActiveListings
          ? _value.storeActiveListings
          : storeActiveListings // ignore: cast_nullable_to_non_nullable
              as int,
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.savedAmountDzd, savedAmountDzd) ||
                other.savedAmountDzd == savedAmountDzd) &&
            (identical(other.storeViewCount, storeViewCount) ||
                other.storeViewCount == storeViewCount) &&
            (identical(other.storeSaveCount, storeSaveCount) ||
                other.storeSaveCount == storeSaveCount) &&
